//news.js
//获取应用实例//获取应用实例App({})来注册一个小程序 //调用根目录下的app.js里的函数：app()
const $vm = getApp()
...
Page({
    ...
    getNewsList(chid = 0,page = 0){
        ...
        //取得网址
        demoUrl = $vm.config.service.newsUrl;
        $vm.utils.post(demoUrl+'v2/news/list.html',{chid:chid,page:infos.page},false).then(res => {
